    ...
    return (
        <>
            ...
            >
                ...
                {/* Ноды обрезаются по границам контейнера */}
                <div
                ...
                {/* ConnectionLayer - с clip-path по границам контейнера */}
                <div 
                ...
                >
                    <ConnectionLayer onContextMenu={handleContextMenu} containerRef={containerRef} pan={pan} scale={scale} viewportSize={viewportSize} />
                </div>
            </div>
