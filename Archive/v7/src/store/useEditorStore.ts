...
export const useEditorStore = create<EditorStore>((set, get) => ({
    ...
    completeLinking: (targetNodeId, targetPortId, _targetPortType) => set((state) => {
        console.log('completeLinking called:', { targetNodeId, targetPortId, _targetPortType, selectedPort: state.selectedPort });
        
        if (!state.selectedPort) {
            console.log('No selectedPort, returning');
            return state;
        }
        ...
        if (fromNodeId === targetNodeId) {
            console.log('Same node, cancelling');
        ...
        if (!sourceNode || !targetNode) {
            console.log('Node not found', { sourceNodeId, targetNodeIdFinal });
            return { ...state, selectedPort: null };
        }
        ...
        if (!sourceDef || !targetDef) {
            console.log('Definition not found', { sourceDef, targetDef });
            return { ...state, selectedPort: null };
        }
        ...
        if (!sourcePort || !targetPort) {
            console.log('Port not found', { sourcePortId, targetPortIdFinal, sourceDef, targetDef });
            return { ...state, selectedPort: null };
        }
        ...
        if (btSource !== btTarget && btSource !== 'any' && btTarget !== 'any') {
            console.log('Type mismatch', { btSource, btTarget });
            return { ...state, selectedPort: null };
        }

        console.log('Creating connection:', { sourceNodeId, sourcePortId, targetNodeId: targetNode.id, targetPortIdFinal });
