    ...
    return (
        ...
        >
            ...
            {data.type === 'data' && (
                <>
                    {(() => {
                        const leftSelected = isPortSelected('left', 'output');
                        const leftCompatible = isPortCompatible('left', 'input');
                        return (
                            <div
                                ...
                                title={leftSelected ? 'Selected port (click again to cancel)' : (leftCompatible ? 'Compatible port (click to connect)' : 'Left')}
                                onClick={(e) => handlePortClick(e, 'left', 'input')}
                            >
                                <div
                                    className={clsx(
                    ...
                    {(() => {
                        const rightSelected = isPortSelected('right', 'output');
                        const rightCompatible = isPortCompatible('right', 'input');
                        return (
                            <div
                                ...
                                title={rightSelected ? 'Selected port (click again to cancel)' : (rightCompatible ? 'Compatible port (click to connect)' : 'Right')}
                                onClick={(e) => handlePortClick(e, 'right', 'input')}
                            >
                                <div
                                    className={clsx(
                                        "w-2.5 h-2.5 rounded-full shadow-sm transition-all",
                    ...
                    {(() => {
                        const topSelected = isPortSelected('top', 'output');
                        const topCompatible = isPortCompatible('top', 'input');
                        return (
                            <div
                                ...
                                title={topSelected ? 'Selected port (click again to cancel)' : (topCompatible ? 'Compatible port (click to connect)' : 'Top')}
                                onClick={(e) => handlePortClick(e, 'top', 'input')}
                            >
                                <div
                                    className={clsx(
                                        "w-2.5 h-2.5 rounded-full shadow-sm transition-all",
                    ...
                    {(() => {
                        const bottomSelected = isPortSelected('bottom', 'output');
                        const bottomCompatible = isPortCompatible('bottom', 'input');
                        return (
                            <div
                                ...
                                title={bottomSelected ? 'Selected port (click again to cancel)' : (bottomCompatible ? 'Compatible port (click to connect)' : 'Bottom')}
                                onClick={(e) => handlePortClick(e, 'bottom', 'input')}
                            >
                                <div
                                    className={clsx(
                                        "w-2.5 h-2.5 rounded-full shadow-sm transition-all",
